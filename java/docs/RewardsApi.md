...
[**deleteRewardsByQueryWithHttpInfo**](RewardsApi.md#deleteRewardsByQueryWithHttpInfo) | **POST** /rewards/delete | NOT AVAILABLE IN CURRENT RELEASE
...
[**getRewardsByAchievementIdWithHttpInfo**](RewardsApi.md#getRewardsByAchievementIdWithHttpInfo) | **GET** /rewards/achievements/{id} | NOT AVAILABLE IN CURRENT RELEASE
[**getRewardsByContestId**](RewardsApi.md#getRewardsByContestId) | **GET** /rewards/contests/{id} | NOT AVAILABLE IN CURRENT RELEASE
[**getRewardsByContestIdWithHttpInfo**](RewardsApi.md#getRewardsByContestIdWithHttpInfo) | **GET** /rewards/contests/{id} | NOT AVAILABLE IN CURRENT RELEASE
...
> CompletableFuture<RewardResponse> getRewardsByAchievementId(id, limit, skip)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer skip = 56; // Integer | Skip the returned records found and return the next batch of records
        try {
            CompletableFuture<RewardResponse> result = apiInstance.getRewardsByAchievementId(id, limit, skip);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling RewardsApi#getRewardsByAchievementId");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getRewardsByAchievementIdWithHttpInfo

> CompletableFuture<ApiResponse<RewardResponse>> getRewardsByAchievementId getRewardsByAchievementIdWithHttpInfo(id, limit, skip)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer skip = 56; // Integer | Skip the returned records found and return the next batch of records
        try {
            CompletableFuture<ApiResponse<RewardResponse>> response = apiInstance.getRewardsByAchievementIdWithHttpInfo(id, limit, skip);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
> CompletableFuture<RewardResponse> getRewardsByContestId(id, limit, skip)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer skip = 56; // Integer | Skip the returned records found and return the next batch of records
        try {
            CompletableFuture<RewardResponse> result = apiInstance.getRewardsByContestId(id, limit, skip);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling RewardsApi#getRewardsByContestId");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getRewardsByContestIdWithHttpInfo

> CompletableFuture<ApiResponse<RewardResponse>> getRewardsByContestId getRewardsByContestIdWithHttpInfo(id, limit, skip)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer skip = 56; // Integer | Skip the returned records found and return the next batch of records
        try {
            CompletableFuture<ApiResponse<RewardResponse>> response = apiInstance.getRewardsByContestIdWithHttpInfo(id, limit, skip);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
