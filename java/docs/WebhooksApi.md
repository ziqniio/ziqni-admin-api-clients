...
[**getWebhooksByQueryWithHttpInfo**](WebhooksApi.md#getWebhooksByQueryWithHttpInfo) | **POST** /webhooks/query | 
...
> CompletableFuture<ModelApiResponse> createWebhooks(body)
...
import com.ziqni.admin.client.api.WebhooksApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateWebhookRequest body = new CreateWebhookRequest(); // CreateWebhookRequest | Create a Webhook in the Ziqni system
        try {
            CompletableFuture<ModelApiResponse> result = apiInstance.createWebhooks(body);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling WebhooksApi#createWebhooks");
...
## createWebhooksWithHttpInfo

> CompletableFuture<ApiResponse<ModelApiResponse>> createWebhooks createWebhooksWithHttpInfo(body)
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateWebhookRequest body = new CreateWebhookRequest(); // CreateWebhookRequest | Create a Webhook in the Ziqni system
        try {
            CompletableFuture<ApiResponse<ModelApiResponse>> response = apiInstance.createWebhooksWithHttpInfo(body);
...
> CompletableFuture<ModelApiResponse> deleteWebhooks(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<ModelApiResponse> result = apiInstance.deleteWebhooks(id);
            System.out.println(result.get());
        } catch (ApiException e) {
...
> CompletableFuture<ApiResponse<ModelApiResponse>> deleteWebhooks deleteWebhooksWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<String> id = Arrays.asList(); // List<String> | The unique identifiers of the resources
        try {
            CompletableFuture<ApiResponse<ModelApiResponse>> response = apiInstance.deleteWebhooksWithHttpInfo(id);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        WebhooksApi apiInstance = new WebhooksApi(defaultClient);
        QueryRequest body = new QueryRequest(); // QueryRequest | Delete a Webhook or a list of Webhooks from Ziqni by unique Webhook ID's or any other POST body parameters using the POST method
        try {
            CompletableFuture<ModelApiResponse> result = apiInstance.deleteWebhooksByQuery(body);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling WebhooksApi#deleteWebhooksByQuery");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## deleteWebhooksByQueryWithHttpInfo
...
public class Example {
    public static void main(String[] args) {
        ...
        QueryRequest body = new QueryRequest(); // QueryRequest | Delete a Webhook or a list of Webhooks from Ziqni by unique Webhook ID's or any other POST body parameters using the POST method
        try {
            CompletableFuture<ApiResponse<ModelApiResponse>> response = apiInstance.deleteWebhooksByQueryWithHttpInfo(body);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
> CompletableFuture<WebhookResponse> getWebhooks(id, limit, skip)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<WebhookResponse> result = apiInstance.getWebhooks(id, limit, skip);
            System.out.println(result.get());
        } catch (ApiException e) {
...
CompletableFuture<[**WebhookResponse**](WebhookResponse.md)>
...
> CompletableFuture<ApiResponse<WebhookResponse>> getWebhooks getWebhooksWithHttpInfo(id, limit, skip)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer skip = 56; // Integer | Skip the returned records found and return the next batch of records
        try {
            CompletableFuture<ApiResponse<WebhookResponse>> response = apiInstance.getWebhooksWithHttpInfo(id, limit, skip);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**WebhookResponse**](WebhookResponse.md)>>
...
> CompletableFuture<WebhookResponse> getWebhooksByQuery(body)
...
public class Example {
    public static void main(String[] args) {
        ...
        WebhooksApi apiInstance = new WebhooksApi(defaultClient);
        QueryRequest body = new QueryRequest(); // QueryRequest | Retrieve a Webhook or a list of Webhooks from Ziqni by unique Webhook ID's or any other Post body parameters using the POST method
        try {
            CompletableFuture<WebhookResponse> result = apiInstance.getWebhooksByQuery(body);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling WebhooksApi#getWebhooksByQuery");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getWebhooksByQueryWithHttpInfo

> CompletableFuture<ApiResponse<WebhookResponse>> getWebhooksByQuery getWebhooksByQueryWithHttpInfo(body)
...
public class Example {
    public static void main(String[] args) {
        ...
        QueryRequest body = new QueryRequest(); // QueryRequest | Retrieve a Webhook or a list of Webhooks from Ziqni by unique Webhook ID's or any other Post body parameters using the POST method
        try {
            CompletableFuture<ApiResponse<WebhookResponse>> response = apiInstance.getWebhooksByQueryWithHttpInfo(body);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
> CompletableFuture<WebhookTriggersResponse> getWebhooksTriggers()
...
public class Example {
    public static void main(String[] args) {
        ...
        WebhooksApi apiInstance = new WebhooksApi(defaultClient);
        try {
            CompletableFuture<WebhookTriggersResponse> result = apiInstance.getWebhooksTriggers();
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling WebhooksApi#getWebhooksTriggers");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
CompletableFuture<[**WebhookTriggersResponse**](WebhookTriggersResponse.md)>
...
## getWebhooksTriggersWithHttpInfo

> CompletableFuture<ApiResponse<WebhookTriggersResponse>> getWebhooksTriggers getWebhooksTriggersWithHttpInfo()
...
public class Example {
    public static void main(String[] args) {
        ...
        WebhooksApi apiInstance = new WebhooksApi(defaultClient);
        try {
            CompletableFuture<ApiResponse<WebhookTriggersResponse>> response = apiInstance.getWebhooksTriggersWithHttpInfo();
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**WebhookTriggersResponse**](WebhookTriggersResponse.md)>>
...
> CompletableFuture<ModelApiResponse> updateWebhooks(body)
...
public class Example {
    public static void main(String[] args) {
        ...
        WebhooksApi apiInstance = new WebhooksApi(defaultClient);
        UpdateWebhookRequest body = new UpdateWebhookRequest(); // UpdateWebhookRequest | Update Webhook details in the Ziqni system
        try {
            CompletableFuture<ModelApiResponse> result = apiInstance.updateWebhooks(body);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling WebhooksApi#updateWebhooks");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> CompletableFuture<ApiResponse<ModelApiResponse>> updateWebhooks updateWebhooksWithHttpInfo(body)
...
public class Example {
    public static void main(String[] args) {
        ...
        UpdateWebhookRequest body = new UpdateWebhookRequest(); // UpdateWebhookRequest | Update Webhook details in the Ziqni system
        try {
            CompletableFuture<ApiResponse<ModelApiResponse>> response = apiInstance.updateWebhooksWithHttpInfo(body);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
