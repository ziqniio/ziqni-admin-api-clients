...
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
    public class ApiKeysApiWs extends ApiKeysApi {
    private final ApiClient apiClient;
    private final ObjectMapper memberVarObjectMapper;
    private final Duration memberVarReadTimeout;
    private final StreamingClient streamingClient;

    public ApiKeysApiWs(ApiClient apiClient, StreamingClient streamingClient, Duration readTimeout) {
        ...
        */
        ...
        CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/aapi/createApiKeys", request);
        return result;
        }
        /**
        * Delete api keys
        ...
        */
        ...
        CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/aapi/deleteApiKeys", request);
        return result;
        }
        /**
        ...
        */
        ...
        CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/aapi/deleteApiKeysById", request);
        return result;
        }
        /**
        ...
        */
        ...
        CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/aapi/deleteApiKeysByQuery", request);
        return result;
        }
        /**
        * Get api keys
...
queryParam.put("skip", skip);
        ...
        CompletableFuture<ApiKeyResponse> result = this.streamingClient.sendWithApiCallback("/aapi/getApiKeys", request);
        return result;
        }
        /**
        * Get api keys by id
        ...
        */
        ...
        CompletableFuture<ApiKeyResponse> result = this.streamingClient.sendWithApiCallback("/aapi/getApiKeysById", request);
        return result;
        }
        /**
        ...
        */
        ...
        CompletableFuture<ApiKeyResponse> result = this.streamingClient.sendWithApiCallback("/aapi/getApiKeysByQuery", request);
        return result;
        }
        /**
        * Update api keys
        ...
        */
        ...
        CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/aapi/updateApiKeys", request);
        return result;
        }
        }
