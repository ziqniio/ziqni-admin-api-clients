...
import com.ziqni.admin.client.model.UpdateWebhookRequestAllOf;
 ...
 */
@JsonPropertyOrder({
  UpdateWebhookRequest.JSON_PROPERTY_ID,
  UpdateWebhookRequest.JSON_PROPERTY_CUSTOM_FIELDS,
  UpdateWebhookRequest.JSON_PROPERTY_TAGS,
  UpdateWebhookRequest.JSON_PROPERTY_METADATA,
  UpdateWebhookRequest.JSON_PROPERTY_POST_TO_URL,
  UpdateWebhookRequest.JSON_PROPERTY_TRIGGERS,
  UpdateWebhookRequest.JSON_PROPERTY_DESCRIPTION,
  UpdateWebhookRequest.JSON_PROPERTY_NAME,
  UpdateWebhookRequest.JSON_PROPERTY_HEADERS
})
...
public class UpdateWebhookRequest {
  ...
  **/
  ...
  public UpdateWebhookRequest customFields(Map<String, Object> customFields) {
    this.customFields = customFields;
    return this;
  }

  public UpdateWebhookRequest putCustomFieldsItem(String key, Object customFieldsItem) {
  ...
  **/
  ...
  public UpdateWebhookRequest tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public UpdateWebhookRequest addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public UpdateWebhookRequest metadata(Map<String, String> metadata) {
    this.metadata = metadata;
    return this;
  }

  public UpdateWebhookRequest putMetadataItem(String key, String metadataItem) {
  ...
  **/
  ...
  public UpdateWebhookRequest postToUrl(String postToUrl) {
  ...
  **/
  ...
  public UpdateWebhookRequest triggers(List<String> triggers) {
    this.triggers = triggers;
    return this;
  }

  public UpdateWebhookRequest addTriggersItem(String triggersItem) {
  ...
  **/
  ...
  public UpdateWebhookRequest headers(Map<String, String> headers) {
    this.headers = headers;
    return this;
  }

  public UpdateWebhookRequest putHeadersItem(String key, String headersItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, updateWebhookRequest.id) &&
        Objects.equals(this.customFields, updateWebhookRequest.customFields) &&
        Objects.equals(this.tags, updateWebhookRequest.tags) &&
        Objects.equals(this.metadata, updateWebhookRequest.metadata) &&
        Objects.equals(this.postToUrl, updateWebhookRequest.postToUrl) &&
        Objects.equals(this.triggers, updateWebhookRequest.triggers) &&
        Objects.equals(this.description, updateWebhookRequest.description) &&
        Objects.equals(this.name, updateWebhookRequest.name) &&
        Objects.equals(this.headers, updateWebhookRequest.headers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, customFields, tags, metadata, postToUrl, triggers, description, name, headers);
  }
