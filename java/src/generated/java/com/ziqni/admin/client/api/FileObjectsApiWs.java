...
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
    public class FileObjectsApiWs extends FileObjectsApi {
    private final ApiClient apiClient;
    private final ObjectMapper memberVarObjectMapper;
    private final Duration memberVarReadTimeout;
    private final StreamingClient streamingClient;

    public FileObjectsApiWs(ApiClient apiClient, StreamingClient streamingClient, Duration readTimeout) {
        ...
        */
        ...
        CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/aapi/copyFileObjects", request);
        return result;
        }
        /**
        * 
        ...
        */
        ...
        CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/aapi/createFileObjects", request);
        return result;
        }
        /**
        * 
...
queryParam.put("permanent", permanent);
        ...
        CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/aapi/deleteFileObjects", request);
        return result;
        }
        /**
        * NOT AVAILABLE IN CURRENT RELEASE
        ...
        */
        ...
        CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/aapi/deleteFileObjectsByQuery", request);
        return result;
        }
        /**
        * NOT AVAILABLE IN CURRENT RELEASE
        ...
        */
        ...
        CompletableFuture<File> result = this.streamingClient.sendWithApiCallback("/aapi/downloadFileObjects", request);
        return result;
        }
        /**
        * 
...
queryParam.put("download", download);
        ...
        CompletableFuture<FileObjectsResponse> result = this.streamingClient.sendWithApiCallback("/aapi/getFileObjects", request);
        return result;
        }
        /**
        * 
        ...
        */
        ...
        CompletableFuture<FileObjectsResponse> result = this.streamingClient.sendWithApiCallback("/aapi/getFileObjectsByQuery", request);
        return result;
        }
        /**
        * NOT AVAILABLE IN CURRENT RELEASE
        ...
        */
        ...
        CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/aapi/saveTemplates", request);
        return result;
        }
        /**
        * 
        ...
        */
        ...
        CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/aapi/updateFileObjects", request);
        return result;
        }
        /**
        * NOT AVAILABLE IN CURRENT RELEASE
        ...
        */
        ...
        CompletableFuture<ModelApiResponse> result = this.streamingClient.sendWithApiCallback("/aapi/uploadFileObjects", request);
        return result;
        }
        }
