 ...
 */
@JsonPropertyOrder({
  UpdateStateRequest.JSON_PROPERTY_ID,
  UpdateStateRequest.JSON_PROPERTY_STATUS
})
...
public class UpdateStateRequest {
  ...
  public UpdateStateRequest id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public UpdateStateRequest status(ConnectionState status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this UpdateStateRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, updateStateRequest.id) &&
        Objects.equals(this.status, updateStateRequest.status);
  }
