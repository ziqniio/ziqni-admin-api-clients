...
import com.ziqni.admin.client.model.AwardAllOf;
import com.ziqni.admin.client.model.EntityType;
import com.ziqni.admin.client.model.ModelDefault;
import com.ziqni.admin.client.model.RewardTypeReduced;
...
@JsonPropertyOrder({
  ...
  Award.JSON_PROPERTY_REWARD_TYPE,
  Award.JSON_PROPERTY_REWARD_RANK,
  Award.JSON_PROPERTY_REWARD_VALUE,
  Award.JSON_PROPERTY_DELAY,
  Award.JSON_PROPERTY_ENTITY_TYPE,
  Award.JSON_PROPERTY_ENTITY_ID,
  Award.JSON_PROPERTY_POINT_IN_TIME,
  Award.JSON_PROPERTY_PERIOD,
  Award.JSON_PROPERTY_TAGS,
  Award.JSON_PROPERTY_METADATA,
  Award.JSON_PROPERTY_CONSTRAINTS,
  Award.JSON_PROPERTY_CLAIMED_TIMESTAMP
})
...
public class Award {
  ...
  **/
  ...
  public Award pointInTime(OffsetDateTime pointInTime) {
  ...
  **/
  ...
  public Award tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public Award addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, spaceName, created, memberId, rewardId, rewardType, rewardRank, rewardValue, delay, entityType, entityId, pointInTime, period, tags, metadata, constraints, claimedTimestamp);
  }
