 ...
 */
@JsonPropertyOrder({
  UpdateUnitOfMeasureRequestAllOf.JSON_PROPERTY_NAME,
  UpdateUnitOfMeasureRequestAllOf.JSON_PROPERTY_DESCRIPTION,
  UpdateUnitOfMeasureRequestAllOf.JSON_PROPERTY_ISO_CODE,
  UpdateUnitOfMeasureRequestAllOf.JSON_PROPERTY_SYMBOL,
  UpdateUnitOfMeasureRequestAllOf.JSON_PROPERTY_MULTIPLIER,
  UpdateUnitOfMeasureRequestAllOf.JSON_PROPERTY_UNIT_OF_MEASURE_TYPE
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class UpdateUnitOfMeasureRequestAllOf {
  ...
  public UpdateUnitOfMeasureRequestAllOf name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public UpdateUnitOfMeasureRequestAllOf description(String description) {
  ...
  **/
  ...
  public UpdateUnitOfMeasureRequestAllOf isoCode(String isoCode) {
  ...
  **/
  ...
  public UpdateUnitOfMeasureRequestAllOf symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  **/
  ...
  public UpdateUnitOfMeasureRequestAllOf multiplier(Double multiplier) {
