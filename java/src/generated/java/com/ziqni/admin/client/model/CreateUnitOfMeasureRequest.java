...
import com.ziqni.admin.client.model.CreateUnitOfMeasureRequestAllOf;
...
public class CreateUnitOfMeasureRequest {
  ...
  public CreateUnitOfMeasureRequest customFields(Map<String, Object> customFields) {
  ...
  **/
  ...
  public CreateUnitOfMeasureRequest tags(List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  **/
  ...
  public CreateUnitOfMeasureRequest metadata(Map<String, String> metadata) {
