...
import com.ziqni.admin.client.model.UpdateProductRequestAllOf;
 ...
 */
@ApiModel(description = "This is a request for Product update")
@JsonPropertyOrder({
  UpdateProductRequest.JSON_PROPERTY_ID,
  UpdateProductRequest.JSON_PROPERTY_CUSTOM_FIELDS,
  UpdateProductRequest.JSON_PROPERTY_TAGS,
  UpdateProductRequest.JSON_PROPERTY_METADATA,
  UpdateProductRequest.JSON_PROPERTY_NAME,
  UpdateProductRequest.JSON_PROPERTY_DESCRIPTION,
  UpdateProductRequest.JSON_PROPERTY_ADJUSTMENT_FACTOR,
  UpdateProductRequest.JSON_PROPERTY_ACTION_TYPE_ADJUSTMENT_FACTORS
})
...
public class UpdateProductRequest {
  ...
  public UpdateProductRequest id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public UpdateProductRequest customFields(Map<String, Object> customFields) {
    this.customFields = customFields;
    return this;
  }

  public UpdateProductRequest putCustomFieldsItem(String key, Object customFieldsItem) {
  ...
  **/
  ...
  public UpdateProductRequest metadata(Map<String, String> metadata) {
    this.metadata = metadata;
    return this;
  }

  public UpdateProductRequest putMetadataItem(String key, String metadataItem) {
  ...
  **/
  ...
  public UpdateProductRequest adjustmentFactor(Double adjustmentFactor) {
  ...
  **/
  ...
  public UpdateProductRequest actionTypeAdjustmentFactors(List<ActionTypeAdjustmentFactor> actionTypeAdjustmentFactors) {
    this.actionTypeAdjustmentFactors = actionTypeAdjustmentFactors;
    return this;
  }

  public UpdateProductRequest addActionTypeAdjustmentFactorsItem(ActionTypeAdjustmentFactor actionTypeAdjustmentFactorsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, updateProductRequest.id) &&
        Objects.equals(this.customFields, updateProductRequest.customFields) &&
        Objects.equals(this.tags, updateProductRequest.tags) &&
        Objects.equals(this.metadata, updateProductRequest.metadata) &&
        Objects.equals(this.name, updateProductRequest.name) &&
        Objects.equals(this.description, updateProductRequest.description) &&
        Objects.equals(this.adjustmentFactor, updateProductRequest.adjustmentFactor) &&
        Objects.equals(this.actionTypeAdjustmentFactors, updateProductRequest.actionTypeAdjustmentFactors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, customFields, tags, metadata, name, description, adjustmentFactor, actionTypeAdjustmentFactors);
  }
