...
/**
 * The CreateEntityRewardRequestAllOf model module.
 * @module model/CreateEntityRewardRequestAllOf
 * @version 0.0.26
 */

class CreateEntityRewardRequestAllOf {
  /**
  ...
  /**
   * Constructs a <code>CreateEntityRewardRequestAllOf</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateEntityRewardRequestAllOf} obj Optional instance to populate.
   * @return {module:model/CreateEntityRewardRequestAllOf} The populated <code>CreateEntityRewardRequestAllOf</code> instance.
   */
...
export default CreateEntityRewardRequestAllOf;