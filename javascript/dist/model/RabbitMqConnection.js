...
class RabbitMqConnection {
   ...
   */
  constructor(id, spaceName, created, name, uri, virtualHost, port, userName, password, queueName, lastKnownStatus, lastKnownStatusCode, constraints, transformerId) {
  ...
  static initialize(obj, id, spaceName, created, name, uri, virtualHost, port, userName, password, queueName, lastKnownStatus, lastKnownStatusCode, constraints, transformerId) {
    obj['id'] = id;
...
OptParamModels.prototype['metadata'] = undefined; // Implement RabbitMqConnectionAllOf interface:
