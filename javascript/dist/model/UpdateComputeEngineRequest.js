  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('statistics')) {
        obj['statistics'] = ApiClient.convertToType(data['statistics'], {
          'String': 'String'
        });
      }
...
UpdateComputeEngineRequest.prototype['removeConstraints'] = undefined; // Implement UpdateModelDefault interface:
...
UpdateModelDefault.prototype['id'] = undefined; // Implement UpdateOptParamModels interface:
...
UpdateOptParamModels.prototype['metadata'] = undefined; // Implement UpdateComputeEngineRequestAllOf interface:
