...
export default class AccountMessagesApi {
  ...
  */
  ...
  deleteAccountMessages(opts, callback) {
    ...
    return this.apiClient.callApi('/account-messages', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  deleteAccountMessagesByQuery(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/account-messages/delete', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getAccountMessages(opts, callback) {
    ...
    return this.apiClient.callApi('/account-messages', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getAccountMessagesByQuery(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = AccountMessageResponse;
    return this.apiClient.callApi('/account-messages/query', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  updateAccountMessagesStatus(body, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/account-messages/state', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
