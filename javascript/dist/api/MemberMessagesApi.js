...
export default class MemberMessagesApi {
  ...
  */
  ...
  createMemberMessages(body, callback) {
    ...
    return this.apiClient.callApi('/member-messages', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  deleteMemberMessages(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/member-messages', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  deleteMemberMessagesByQuery(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/member-messages/delete', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getMemberMessages(opts, callback) {
    ...
    return this.apiClient.callApi('/member-messages', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getMemberMessagesByQuery(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = MemberMessageResponse;
    return this.apiClient.callApi('/member-messages/query', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  updateMemberMessagesStatus(body, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/member-messages/state', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
