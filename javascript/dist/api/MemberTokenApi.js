...
export default class MemberTokenApi {
  ...
  */
  ...
  createMemberToken(memberTokenRequest, callback) {
    let postBody = memberTokenRequest; // verify the required parameter 'memberTokenRequest' is set
    ...
    return this.apiClient.callApi('/member-token', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
