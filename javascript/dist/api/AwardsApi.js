...
export default class AwardsApi {
  ...
  */
  ...
  claimAwards(body, callback) {
    ...
    return this.apiClient.callApi('/awards/claim', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getAwards(opts, callback) {
    ...
    return this.apiClient.callApi('/awards', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getAwardsByQuery(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = AwardResponse;
    return this.apiClient.callApi('/awards/query', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
