...
export default class DefaultApi {
  ...
  */
  ...
  deleteSpace(name, callback) {
    let postBody = null; // verify the required parameter 'name' is set
    ...
    let returnType = null;
    return this.apiClient.callApi('/spaces', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
