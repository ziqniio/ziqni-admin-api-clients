...
export default class RewardTypesApi {
  ...
  */
  ...
  createRewardTypes(body, callback) {
    ...
    return this.apiClient.callApi('/reward-types', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  deleteRewardTypes(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/reward-types', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  deleteRewardTypesByQuery(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/reward-types/delete', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getRewardTypes(opts, callback) {
    ...
    return this.apiClient.callApi('/reward-types', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getRewardTypesByQuery(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = RewardTypeResponse;
    return this.apiClient.callApi('/reward-types/query', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  updateRewardTypes(body, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/reward-types', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
