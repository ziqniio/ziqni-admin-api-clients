...
export default class TranslationsApi {
  ...
  */
  ...
  createTranslations(createTranslationRequest, callback) {
    let postBody = createTranslationRequest; // verify the required parameter 'createTranslationRequest' is set
    ...
    return this.apiClient.callApi('/translations', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  deleteTranslations(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/translations', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  deleteTranslationsByQuery(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/translations/delete', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getTranslations(opts, callback) {
    ...
    return this.apiClient.callApi('/translations', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getTranslationsByEntityId(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = TranslationResponse;
    return this.apiClient.callApi('/translations/find-by-entity-id', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getTranslationsByQuery(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = TranslationResponse;
    return this.apiClient.callApi('/translations/query', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  updateTranslations(body, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/translations', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
