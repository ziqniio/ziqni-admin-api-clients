...
export default class UnitsOfMeasureApi {
  ...
  */
  ...
  createUnitsOfMeasure(body, callback) {
    ...
    return this.apiClient.callApi('/units-of-measure', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  deleteCollaboratorsByQuery(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/collaborators/delete', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  deleteUnitsOfMeasure(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/units-of-measure', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  deleteUnitsOfMeasureByQuery(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/units-of-measure/delete', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getUnitsOfMeasure(opts, callback) {
    ...
    return this.apiClient.callApi('/units-of-measure', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getUnitsOfMeasureByQuery(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = UnitOfMeasureResponse;
    return this.apiClient.callApi('/units-of-measure/query', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  updateUnitsOfMeasure(body, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = ApiResponse;
    return this.apiClient.callApi('/units-of-measure', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
