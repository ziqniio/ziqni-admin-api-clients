 ...
 * @version 0.0.26
 */
var CreateContestRequestAllOf = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateContestRequestAllOf(name, roundType, minNumberOfEntrants, scheduledStartDate, scheduledEndDate, strategies, constraints) {
    _classCallCheck(this, CreateContestRequestAllOf);
  ...
  _createClass(CreateContestRequestAllOf, null, [{
    key: "initialize",
    value: function initialize(obj, name, roundType, minNumberOfEntrants, scheduledStartDate, scheduledEndDate, strategies, constraints) {
      obj['name'] = name;
  ...
  return CreateContestRequestAllOf;
}();
/**
...
var _default = CreateContestRequestAllOf;
