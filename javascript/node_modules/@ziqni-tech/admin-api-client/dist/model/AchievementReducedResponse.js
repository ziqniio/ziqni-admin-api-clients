...
var _AchievementReduced = _interopRequireDefault(require("./AchievementReduced"));
 ...
 * @version 0.0.26
 */
var AchievementReducedResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function AchievementReducedResponse(meta) {
    _classCallCheck(this, AchievementReducedResponse);
  ...
  _createClass(AchievementReducedResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_AchievementReduced["default"]]);
        }
  ...
  return AchievementReducedResponse;
}();
/**
...
var _default = AchievementReducedResponse;
