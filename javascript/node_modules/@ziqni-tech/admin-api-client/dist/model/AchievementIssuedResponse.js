...
var _AchievementIssuedCount = _interopRequireDefault(require("./AchievementIssuedCount"));
 ...
 * @version 0.0.26
 */
var AchievementIssuedResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function AchievementIssuedResponse(meta) {
    _classCallCheck(this, AchievementIssuedResponse);
  ...
  _createClass(AchievementIssuedResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_AchievementIssuedCount["default"]]);
        }
  ...
  return AchievementIssuedResponse;
}();
/**
...
var _default = AchievementIssuedResponse;
