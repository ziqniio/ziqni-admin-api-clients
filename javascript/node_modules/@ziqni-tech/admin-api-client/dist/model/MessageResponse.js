...
var MessageResponse = /*#__PURE__*/function () {
  ...
  _createClass(MessageResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_Message["default"]]);
        }
