...
var _CollaboratorRolesAvailable = _interopRequireDefault(require("./CollaboratorRolesAvailable"));
 ...
 * @version 0.0.26
 */
var CollaboratorRolesResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function CollaboratorRolesResponse(meta) {
    _classCallCheck(this, CollaboratorRolesResponse);
  ...
  _createClass(CollaboratorRolesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_CollaboratorRolesAvailable["default"]]);
        }
  ...
  return CollaboratorRolesResponse;
}();
/**
...
var _default = CollaboratorRolesResponse;
