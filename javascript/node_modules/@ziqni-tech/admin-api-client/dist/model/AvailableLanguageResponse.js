 ...
 * @version 0.0.26
 */
var AvailableLanguageResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function AvailableLanguageResponse(meta) {
    _classCallCheck(this, AvailableLanguageResponse);
  ...
  _createClass(AvailableLanguageResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_Languages["default"]]);
        }
  ...
  return AvailableLanguageResponse;
}();
/**
...
var _default = AvailableLanguageResponse;
