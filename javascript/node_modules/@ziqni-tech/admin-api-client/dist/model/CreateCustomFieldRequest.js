...
var _AppliesTo = _interopRequireDefault(require("./AppliesTo"));
...
var CreateCustomFieldRequest = /*#__PURE__*/function () {
   ...
   */
  function CreateCustomFieldRequest(name, key, fieldType, appliesTo) {
  ...
  _createClass(CreateCustomFieldRequest, null, [{
    key: "initialize",
    value: function initialize(obj, name, key, fieldType, appliesTo) {
      obj['name'] = name;
      obj['key'] = key;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('fieldType')) {
          obj['fieldType'] = _FieldType["default"].constructFromObject(data['fieldType']);
        }

        if (data.hasOwnProperty('appliesTo')) {
          obj['appliesTo'] = _AppliesTo["default"].constructFromObject(data['appliesTo']);
        }
      }
...
var _default = CreateCustomFieldRequest;
