...
var ContestAllOf = /*#__PURE__*/function () {
   ...
   */
  function ContestAllOf(competitionId, row, name, round, roundType, entrantsFromContest, minNumberOfEntrants, scheduledStartDate, scheduledEndDate, status, statusCode, constraints) {
  ...
  _createClass(ContestAllOf, null, [{
    key: "initialize",
    value: function initialize(obj, competitionId, row, name, round, roundType, entrantsFromContest, minNumberOfEntrants, scheduledStartDate, scheduledEndDate, status, statusCode, constraints) {
