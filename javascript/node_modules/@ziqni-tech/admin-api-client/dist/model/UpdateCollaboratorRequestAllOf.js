 ...
 * @version 0.0.26
 */
var UpdateCollaboratorRequestAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateCollaboratorRequestAllOf</code>.
   * @alias module:model/UpdateCollaboratorRequestAllOf
   * @param email {String} 
   */
  function UpdateCollaboratorRequestAllOf(email) {
    _classCallCheck(this, UpdateCollaboratorRequestAllOf);
  ...
  _createClass(UpdateCollaboratorRequestAllOf, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('addRoles')) {
          obj['addRoles'] = _ApiClient["default"].convertToType(data['addRoles'], ['String']);
        }

        if (data.hasOwnProperty('removeRoles')) {
          obj['removeRoles'] = _ApiClient["default"].convertToType(data['removeRoles'], ['String']);
        }
      }
  ...
  return UpdateCollaboratorRequestAllOf;
}();
/**
 * @member {String} email
 */
...
var _default = UpdateCollaboratorRequestAllOf;
