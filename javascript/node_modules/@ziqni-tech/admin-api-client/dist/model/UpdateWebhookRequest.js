...
var _UpdateWebhookRequestAllOf = _interopRequireDefault(require("./UpdateWebhookRequestAllOf"));
...
var UpdateWebhookRequest = /*#__PURE__*/function () {
   ...
   */
  function UpdateWebhookRequest(id) {
    ...
    _UpdateWebhookRequestAllOf["default"].initialize(this);
  ...
  _createClass(UpdateWebhookRequest, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _UpdateWebhookRequestAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('postToUrl')) {
          obj['postToUrl'] = _ApiClient["default"].convertToType(data['postToUrl'], 'String');
        }
...
_UpdateOptParamModels["default"].prototype['metadata'] = undefined; // Implement UpdateWebhookRequestAllOf interface:
...
_UpdateWebhookRequestAllOf["default"].prototype['postToUrl'] = undefined;
/**
 * A list of event triggers
 * @member {Array.<String>} triggers
 */

_UpdateWebhookRequestAllOf["default"].prototype['triggers'] = undefined;
/**
 * The description of a Webhook
 * @member {String} description
 */

_UpdateWebhookRequestAllOf["default"].prototype['description'] = undefined;
/**
 * The name of a Webhook
 * @member {String} name
 */

_UpdateWebhookRequestAllOf["default"].prototype['name'] = undefined;
/**
 * @member {Object.<String, String>} headers
 */

_UpdateWebhookRequestAllOf["default"].prototype['headers'] = undefined;
