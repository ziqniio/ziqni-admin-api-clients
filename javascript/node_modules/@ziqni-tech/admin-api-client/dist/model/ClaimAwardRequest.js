 ...
 * @version 0.0.26
 */
var ClaimAwardRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function ClaimAwardRequest(id, constraints) {
    _classCallCheck(this, ClaimAwardRequest);
  ...
  _createClass(ClaimAwardRequest, null, [{
    key: "initialize",
    value: function initialize(obj, id, constraints) {
      obj['id'] = id;
...
var _default = ClaimAwardRequest;
