...
var _RewardTypeAllOf = _interopRequireDefault(require("./RewardTypeAllOf"));
 ...
 * @version 0.0.26
 */
var RewardType = /*#__PURE__*/function () {
  /**
   ...
   */
  function RewardType(id, spaceName, created, name, key, unitOfMeasureType, constraints) {
    _classCallCheck(this, RewardType);

    _ModelDefault["default"].initialize(this, id, spaceName, created);

    _OptParamModels["default"].initialize(this);

    _RewardTypeAllOf["default"].initialize(this, name, key, unitOfMeasureType, constraints);
  ...
  _createClass(RewardType, null, [{
    key: "initialize",
    value: function initialize(obj, id, spaceName, created, name, key, unitOfMeasureType, constraints) {
      obj['id'] = id;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _RewardTypeAllOf["default"].constructFromObject(data, obj);
...
_OptParamModels["default"].prototype['metadata'] = undefined; // Implement RewardTypeAllOf interface:
...
_RewardTypeAllOf["default"].prototype['name'] = undefined;
/**
 * The description of a reward type
 * @member {String} description
 */

_RewardTypeAllOf["default"].prototype['description'] = undefined;
/**
 * A unique key that represents the reward type
 * @member {String} key
 */

_RewardTypeAllOf["default"].prototype['key'] = undefined;
/**
 * @member {module:model/UnitOfMeasureType} unitOfMeasureType
 */

_RewardTypeAllOf["default"].prototype['unitOfMeasureType'] = undefined;
/**
 * Additional constraints, if the value is present it means the
 * @member {Array.<String>} constraints
 */

_RewardTypeAllOf["default"].prototype['constraints'] = undefined;
var _default = RewardType;
