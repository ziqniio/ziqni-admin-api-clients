...
var _CreateCompetitionRequest = _interopRequireDefault(require("./CreateCompetitionRequest"));
 ...
 * @version 0.0.26
 */
var CloneCompetitionResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function CloneCompetitionResponse(meta) {
    _classCallCheck(this, CloneCompetitionResponse);
  ...
  _createClass(CloneCompetitionResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_CreateCompetitionRequest["default"]]);
        }
  ...
  return CloneCompetitionResponse;
}();
/**
...
var _default = CloneCompetitionResponse;
