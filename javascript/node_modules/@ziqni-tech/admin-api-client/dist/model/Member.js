...
var _MemberAllOf = _interopRequireDefault(require("./MemberAllOf"));
...
var Member = /*#__PURE__*/function () {
   ...
   */
  function Member(id, spaceName, created, name, memberRefId, memberType) {
    ...
    _MemberAllOf["default"].initialize(this, name, memberRefId, memberType);
  ...
  _createClass(Member, null, [{
    key: "initialize",
    value: function initialize(obj, id, spaceName, created, name, memberRefId, memberType) {
      obj['id'] = id;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _MemberAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('memberType')) {
          obj['memberType'] = _MemberType["default"].constructFromObject(data['memberType']);
        }

        if (data.hasOwnProperty('teamMembers')) {
          obj['teamMembers'] = _ApiClient["default"].convertToType(data['teamMembers'], ['String']);
        }
        ...
        if (data.hasOwnProperty('timeZoneOffset')) {
          obj['timeZoneOffset'] = _ApiClient["default"].convertToType(data['timeZoneOffset'], 'String');
        }
      }
...
_OptParamModels["default"].prototype['metadata'] = undefined; // Implement MemberAllOf interface:
...
_MemberAllOf["default"].prototype['name'] = undefined;
/**
 * The reference to this member in your system
 * @member {String} memberRefId
 */

_MemberAllOf["default"].prototype['memberRefId'] = undefined;
/**
 * @member {module:model/MemberType} memberType
 */

_MemberAllOf["default"].prototype['memberType'] = undefined;
/**
 * A social group like Guilds
 * @member {Array.<String>} teamMembers
 */

_MemberAllOf["default"].prototype['teamMembers'] = undefined;
/**
 * Additional constraints
 * @member {Array.<String>} constraints
 */

_MemberAllOf["default"].prototype['constraints'] = undefined;
/**
 * To what time zone teh emmber belongs to
 * @member {String} timeZoneOffset
 */

_MemberAllOf["default"].prototype['timeZoneOffset'] = undefined;
var _default = Member;
