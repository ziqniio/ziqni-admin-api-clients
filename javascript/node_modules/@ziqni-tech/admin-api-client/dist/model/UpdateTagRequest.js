...
var _UpdateTagRequestAllOf = _interopRequireDefault(require("./UpdateTagRequestAllOf"));
 ...
 * @version 0.0.26
 */
var UpdateTagRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function UpdateTagRequest(id) {
    _classCallCheck(this, UpdateTagRequest);

    _UpdateModelDefault["default"].initialize(this, id);

    _UpdateTagRequestAllOf["default"].initialize(this);
  ...
  _createClass(UpdateTagRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _UpdateTagRequestAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('entityTypes')) {
          obj['entityTypes'] = _ApiClient["default"].convertToType(data['entityTypes'], ['String']);
        }
...
_UpdateModelDefault["default"].prototype['id'] = undefined; // Implement UpdateTagRequestAllOf interface:
...
_UpdateTagRequestAllOf["default"].prototype['name'] = undefined;
/**
 * The description of the tag for your reference
 * @member {String} description
 */

_UpdateTagRequestAllOf["default"].prototype['description'] = undefined;
/**
 * The model name the tag refers to
 * @member {Array.<String>} entityTypes
 */

_UpdateTagRequestAllOf["default"].prototype['entityTypes'] = undefined;
/**
 * @member {Object.<String, String>} metadata
 */

_UpdateTagRequestAllOf["default"].prototype['metadata'] = undefined;
var _default = UpdateTagRequest;
