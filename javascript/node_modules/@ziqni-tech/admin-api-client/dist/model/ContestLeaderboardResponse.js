 ...
 * @version 0.0.26
 */
var ContestLeaderboardResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ContestLeaderboardResponse(meta) {
    _classCallCheck(this, ContestLeaderboardResponse);
  ...
  _createClass(ContestLeaderboardResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_Leaderboard["default"]]);
        }
...
var _default = ContestLeaderboardResponse;
