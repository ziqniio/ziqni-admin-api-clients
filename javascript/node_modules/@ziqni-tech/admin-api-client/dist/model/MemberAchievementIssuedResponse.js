...
var _MemberAchievementCount = _interopRequireDefault(require("./MemberAchievementCount"));
 ...
 * @version 0.0.26
 */
var MemberAchievementIssuedResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function MemberAchievementIssuedResponse(meta) {
    _classCallCheck(this, MemberAchievementIssuedResponse);
  ...
  _createClass(MemberAchievementIssuedResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_MemberAchievementCount["default"]]);
        }
  ...
  return MemberAchievementIssuedResponse;
}();
/**
...
var _default = MemberAchievementIssuedResponse;
