 ...
 * @version 0.0.26
 */
var RangeQuery = /*#__PURE__*/function () {
  /**
   ...
   */
  function RangeQuery(queryField) {
  ...
  _createClass(RangeQuery, null, [{
    key: "initialize",
    value: function initialize(obj, queryField) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('queryField')) {
          obj['queryField'] = _ApiClient["default"].convertToType(data['queryField'], 'String');
        }

        if (data.hasOwnProperty('gt')) {
          obj['gt'] = _ApiClient["default"].convertToType(data['gt'], 'String');
        }

        if (data.hasOwnProperty('lt')) {
          obj['lt'] = _ApiClient["default"].convertToType(data['lt'], 'String');
        }
