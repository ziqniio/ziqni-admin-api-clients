 ...
 * @version 0.0.26
 */
var ActionTypeAllOf = /*#__PURE__*/function () {
  /**
   ...
   */
  function ActionTypeAllOf(name, key, unitOfMeasureType, constraints) {
    _classCallCheck(this, ActionTypeAllOf);
  ...
  _createClass(ActionTypeAllOf, null, [{
    key: "initialize",
    value: function initialize(obj, name, key, unitOfMeasureType, constraints) {
      obj['name'] = name;
      obj['key'] = key;
