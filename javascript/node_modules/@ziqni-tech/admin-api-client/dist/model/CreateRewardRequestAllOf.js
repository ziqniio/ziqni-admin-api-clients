 ...
 * @version 0.0.26
 */
var CreateRewardRequestAllOf = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateRewardRequestAllOf(name, rewardRank, rewardValue, delay, rewardTypeId) {
    _classCallCheck(this, CreateRewardRequestAllOf);
  ...
  _createClass(CreateRewardRequestAllOf, null, [{
    key: "initialize",
    value: function initialize(obj, name, rewardRank, rewardValue, delay, rewardTypeId) {
      obj['name'] = name;
  ...
  return CreateRewardRequestAllOf;
}();
/**
...
var _default = CreateRewardRequestAllOf;
