...
var _ContestReduced = _interopRequireDefault(require("./ContestReduced"));
 ...
 * @version 0.0.26
 */
var ContestReducedResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ContestReducedResponse(meta) {
    _classCallCheck(this, ContestReducedResponse);
  ...
  _createClass(ContestReducedResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_ContestReduced["default"]]);
        }
...
var _default = ContestReducedResponse;
