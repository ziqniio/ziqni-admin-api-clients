...
var RuleArgument = /*#__PURE__*/function () {
  ...
  _createClass(RuleArgument, null, [{
    key: "initialize",
    value: function initialize(obj, argument) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('argument')) {
          obj['argument'] = _ApiClient["default"].convertToType(data['argument'], 'String');
        }
