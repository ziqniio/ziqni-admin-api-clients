...
var _HostingOptions = _interopRequireDefault(require("./HostingOptions"));
 ...
 * @version 0.0.26
 */
var UpdateRepositoryRequestAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateRepositoryRequestAllOf</code>.
   * @alias module:model/UpdateRepositoryRequestAllOf
   */
  function UpdateRepositoryRequestAllOf() {
    _classCallCheck(this, UpdateRepositoryRequestAllOf);
  ...
  _createClass(UpdateRepositoryRequestAllOf, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('removeConstraints')) {
          obj['removeConstraints'] = _ApiClient["default"].convertToType(data['removeConstraints'], ['String']);
        }

        if (data.hasOwnProperty('hostingOptions')) {
          obj['hostingOptions'] = _HostingOptions["default"].constructFromObject(data['hostingOptions']);
        }
      }
  ...
  return UpdateRepositoryRequestAllOf;
}();
/**
...
var _default = UpdateRepositoryRequestAllOf;
