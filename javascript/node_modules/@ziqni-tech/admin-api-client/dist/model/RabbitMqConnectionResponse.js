 ...
 * @version 0.0.26
 */
var RabbitMqConnectionResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function RabbitMqConnectionResponse(meta) {
    _classCallCheck(this, RabbitMqConnectionResponse);
  ...
  _createClass(RabbitMqConnectionResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_RabbitMqConnection["default"]]);
        }
  ...
  return RabbitMqConnectionResponse;
}();
/**
...
var _default = RabbitMqConnectionResponse;
