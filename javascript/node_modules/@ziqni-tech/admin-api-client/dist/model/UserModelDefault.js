 ...
 * @version 0.0.26
 */
var UserModelDefault = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UserModelDefault</code>.
   * @alias module:model/UserModelDefault
   * @param objectType {String} 
   */
  function UserModelDefault(objectType) {
    _classCallCheck(this, UserModelDefault);
  ...
  _createClass(UserModelDefault, null, [{
    key: "initialize",
    value: function initialize(obj, objectType) {
