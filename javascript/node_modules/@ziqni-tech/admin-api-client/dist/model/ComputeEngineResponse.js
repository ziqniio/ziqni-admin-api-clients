...
var _ComputeEngine = _interopRequireDefault(require("./ComputeEngine"));
 ...
 * @version 0.0.26
 */
var ComputeEngineResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function ComputeEngineResponse(meta) {
    _classCallCheck(this, ComputeEngineResponse);
  ...
  _createClass(ComputeEngineResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_ComputeEngine["default"]]);
        }
...
var _default = ComputeEngineResponse;
