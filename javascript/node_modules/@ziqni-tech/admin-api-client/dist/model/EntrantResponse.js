...
var _Entrant = _interopRequireDefault(require("./Entrant"));
...
var EntrantResponse = /*#__PURE__*/function () {
  ...
  _createClass(EntrantResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient["default"].convertToType(data['results'], [_Entrant["default"]]);
        }
